...
const S = {
  ...
  exampleBlock: { background: "rgba(13, 17, 36, 0.66)", border: "1px solid rgba(125, 140, 255, 0.18)", borderRadius: 12, padding: "20px 24px", margin: "20px 0", fontSize: 15, lineHeight: 1.85, color: "#C3CCE8", fontStyle: "italic" },
