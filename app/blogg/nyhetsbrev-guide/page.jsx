...
const S = {
  ...
  formatCard: { background: "rgba(13, 17, 36, 0.66)", border: "1px solid rgba(125, 140, 255, 0.18)", borderRadius: 10, padding: "16px 20px", margin: "10px 0" },
  toolRow: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", background: "rgba(13, 17, 36, 0.66)", border: "1px solid rgba(125, 140, 255, 0.18)", borderRadius: 10, padding: "14px 18px", margin: "10px 0" },
