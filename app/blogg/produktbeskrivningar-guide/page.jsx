...
const S = {
  ...
  stepNum: { display: "inline-flex", alignItems: "center", justifyContent: "center", width: 32, height: 32, background: "rgba(129, 140, 248, 0.13)", color: "#A5B4FC", borderRadius: "50%", fontSize: 14, fontWeight: 700, marginRight: 10, flexShrink: 0 },
  compRow: { display: "flex", flexDirection: "column", gap: 8, margin: "20px 0" },
  compBad: { background: "rgba(248, 113, 113, 0.09)", border: "1px solid rgba(248, 113, 113, 0.28)", borderRadius: 10, padding: "14px 16px", fontSize: 15, color: "#C3CCE8", lineHeight: 1.7 },
  compGood: { background: "rgba(52, 211, 153, 0.1)", border: "1px solid rgba(52, 211, 153, 0.32)", borderRadius: 10, padding: "14px 16px", fontSize: 15, color: "#C3CCE8", lineHeight: 1.7 },
  ...
  featureItem: { display: "flex", gap: 12, alignItems: "flex-start", padding: "14px 16px", background: "rgba(13, 17, 36, 0.66)", border: "1px solid rgba(125, 140, 255, 0.18)", borderRadius: 10 },
  featureArrow: { color: "#A5B4FC", fontWeight: 700, fontSize: 16, flexShrink: 0, marginTop: 2 },
