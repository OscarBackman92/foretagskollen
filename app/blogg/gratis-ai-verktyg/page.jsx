...
const S = {
  ...
  toolCard: { background: "rgba(13, 17, 36, 0.66)", border: "1px solid rgba(125, 140, 255, 0.18)", borderRadius: 12, padding: "24px", margin: "20px 0" },
  toolNum: { display: "inline-flex", alignItems: "center", justifyContent: "center", width: 28, height: 28, background: "rgba(16, 21, 44, 0.8)", color: "#fff", borderRadius: "50%", fontSize: 13, fontWeight: 700, marginRight: 10, flexShrink: 0 },
  toolTitle: { fontWeight: 700, fontSize: 18, color: "#EAEEFF", display: "flex", alignItems: "center", marginBottom: 8 },
  toolBadge: { display: "inline-block", background: "rgba(52, 211, 153, 0.1)", color: "#34D399", fontSize: 11, fontWeight: 700, padding: "2px 9px", borderRadius: 4, marginLeft: 10, letterSpacing: 0.5, textTransform: "uppercase" },
  toolBest: { fontSize: 13, color: "#949EC9", fontStyle: "italic", marginBottom: 10 },
